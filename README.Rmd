...
[![CRAN status](https://www.r-pkg.org/badges/version/ykwim)](https://CRAN.R-project.org/package=ykwim)
[![Codecov test coverage](https://codecov.io/gh/jonthegeek/ykwim/branch/main/graph/badge.svg)](https://app.codecov.io/gh/jonthegeek/ykwim?branch=main)
...
Without the argument-stabilizers provided in ykwim, error messages can be cryptic, and errors trigger when you might not want them to.
